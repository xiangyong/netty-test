...
/**
 * A string which has been encoded into a character encoding whose character
 * always takes a single byte, similarly to ASCII. It internally keeps its
 * content in a byte array unlike {@link String}, which uses a character array,
 * for reduced memory footprint and faster data transfer from/to byte-based data
 * structures such as a byte array and {@link ByteBuf}. It is often used in
 * conjunction with {@link TextHeaders}.
 */
public final class AsciiString implements CharSequence, Comparable<CharSequence> {
	...
	/**
	 * Returns the case-insensitive hash code of the specified string. Note that
	 * this method uses the same hashing algorithm with {@link #hashCode()} so
	 * that you can put both {@link AsciiString}s and arbitrary
	 ...
	 * ignore the case. This only supports 8-bit ASCII.
	 */
	...
	/**
	 * Returns {@code true} if both {@link CharSequence}'s are equals. This only
	 ...
	 * character in this string has an ASCII value which is less than the ASCII
	 * value of the character at the same position in the specified string, or
	 * if this string is a prefix of the specified string. Returns a positive
	 * integer if the first non-equal character in this string has a ASCII value
	 * which is greater than the ASCII value of the character at the same
	 * position in the specified string, or if the specified string is a prefix
	 * of this string.
	 * 
	 * @param string
	 ...
	 * is less than the ASCII value of the character at the same position in the
	 * specified string, or if this string is a prefix of the specified string.
	 * Returns a positive integer if the first non-equal character in this
	 * string has an ASCII value which is greater than the ASCII value of the
	 * character at the same position in the specified string, or if the
	...
	/**
	 * Copies the content of this string to a {@link ByteBuf} using
	 ...
	 * end of the string.
	 * 
	 * @return a new string with characters {@code <= \\u0020} removed from the
